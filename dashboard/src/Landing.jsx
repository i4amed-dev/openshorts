...
import { Sparkles, Zap, Globe, FileVideo, Subtitles, Youtube, Instagram, Shield, ArrowRight, Check, ChevronDown, Monitor, Cpu, Languages, Type, Upload, Scissors, Link2 } from 'lucide-react';
...
const ComparisonRow = ({ feature, klippo, opusclip, kapwing }) => (
  <tr className="border-b border-rule">
    <td className="py-3 px-4 text-sm text-ink2">{feature}</td>
    <td className="py-3 px-4 text-center">{klippo}</td>
    ...
    <div className="min-h-screen bg-paper text-ink2 overflow-x-clip">
      ...
      <nav className="fixed top-0 w-full z-50 bg-paper border-b border-rule">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src="/brand/favicon.svg" alt="Klippo logo" className="w-7 h-7" />
            <span className="font-display text-lg lowercase text-ink">Klippo</span>
          </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_auto] gap-14 items-center">
          <div className="min-w-0">
            ...
            <h1 className="hero-h1 mb-6">
              the self-hosted ai <em>clip generator</em>, built to clip what people actually watch.
            </h1>
          ...
          <figure className="apparatus" aria-label="example vertical clip generated by klippo">
      ...
      <section className="border-b border-rule">
        <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-3 divide-x divide-rule text-center">
          ...
          <div className="px-4">
            ...
            <div className="eyebrow mt-2">Self-hosted</div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-10">
            ...
            <figure className="crop-frame w-[180px] md:w-[210px] flex-none" aria-label="vertical 9:16 clip generated by klippo">
              <video
                src="/demo/clip-vertical.mp4"
                autoPlay
                muted
      ...
      <section className="py-20 px-6 border-t border-rule">
        <div className="max-w-4xl mx-auto">
          <SectionHeader eyebrow="02 · Deploy" title="Two ways to use Klippo">
            The same software, running either on our GPU or on your machine.
          </SectionHeader>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="card p-8 flex flex-col border-brass">
              <div className="flex flex-wrap items-center gap-3 mb-3">
                <Sparkles size={18} className="text-brass" />
                <h3 className="font-display text-2xl lowercase text-ink">cloud — klippo.one</h3>
              ...
              {billingEnabled ? (
                ...
                <button onClick={onLaunchApp} className="btn-primary whitespace-nowrap">
                  launch klippo <ArrowRight size={16} />
                </button>
              )}
            </div>
            <div className="card p-8 flex flex-col">
              ...
              <button onClick={onLaunchApp} className="btn-ghost whitespace-nowrap">
                <Monitor size={16} /> run it yourself
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            <div className="card p-8">
              ...
              <p className="text-muted text-sm leading-relaxed mb-4">AI clipping tool: turn long-form videos into viral-ready 9:16 shorts.</p>
      ...
      <section id="features" className="py-20 px-6 border-t border-rule">
        <div className="max-w-6xl mx-auto">
          <SectionHeader eyebrow="05 · Features" title="Free AI Clip Generator + UGC Video Creator">
            The self-hosted clip generator & AI UGC video creator. A smart AI video clipper for TikTok, Reels & Shorts.
          </SectionHeader>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            <div className="card p-6 relative">
              ...
              <p className="text-muted text-sm leading-relaxed">Powers all AI features: viral moment detection, title generation, video effects, YouTube thumbnail creation, and description writing. The core engine of Klippo.</p>
            </div>
            <div className="card p-6 relative">
            ...
            <div className="card p-6 relative">
              ...
              <div className="mb-3"><span className="badge-ok">Free tier included</span></div>
              <p className="text-muted text-sm leading-relaxed">Enables direct publishing to YouTube, TikTok, and Instagram Reels from the dashboard. <a href="https://www.upload-post.com" target="_blank" rel="noopener noreferrer" className="text-brass underline hover:brightness-110">Social media API</a> that lets you post your clips and thumbnails without leaving Klippo.</p>
            </div>
          </div>
      ...
      <section className="py-20 px-6 border-t border-rule">
        <div className="max-w-5xl mx-auto">
          <SectionHeader eyebrow="08 · Stack" title="Built with Proven Technology">
            Industry-leading AI models in one pipeline.
          </SectionHeader>
      ...
      <section id="comparison" className="py-20 px-6 border-t border-rule">
        <div className="max-w-4xl mx-auto">
          <SectionHeader eyebrow="09 · Comparison" title="Free Clip Generator vs Paid Alternatives">
            Hosted Klippo starts at $12/mo — or self-host free. Opus Clip runs $15-228/month, Kapwing $24-79/month.
          </SectionHeader>
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="border-b border-rule2">
                  ...
                  <th className="py-3 px-4 text-center text-sm font-medium">
                    <span className="text-brass">Klippo</span>
                  </th>
              ...
              <tbody>
                <ComparisonRow feature="Price" klippo={<span className="text-ok font-medium">$0 Free</span>} opusclip={xIcon} kapwing={xIcon} />
                <ComparisonRow feature="AI Viral Moment Detection" klippo={checkIcon} opusclip={checkMuted} kapwing={checkMuted} />
                <ComparisonRow feature="Smart Vertical Cropping" klippo={checkIcon} opusclip={checkMuted} kapwing={checkMuted} />
                <ComparisonRow feature="Auto Subtitles" klippo={checkIcon} opusclip={checkMuted} kapwing={checkMuted} />
                <ComparisonRow feature="AI Voice Dubbing (30+ langs)" klippo={checkIcon} opusclip={<span className="text-muted text-sm">Limited</span>} kapwing={<span className="text-muted text-sm">No</span>} />
                <ComparisonRow feature="AI Video Effects" klippo={checkIcon} opusclip={<span className="text-muted text-sm">No</span>} kapwing={checkMuted} />
                <ComparisonRow feature="Hook Text Overlays" klippo={checkIcon} opusclip={checkMuted} kapwing={checkMuted} />
                <ComparisonRow feature="Self-Hosted / Privacy" klippo={checkIcon} opusclip={<span className="text-muted text-sm">Cloud only</span>} kapwing={<span className="text-muted text-sm">Cloud only</span>} />
                <ComparisonRow feature="No Watermark" klippo={checkIcon} opusclip={<span className="text-muted text-sm">Free tier only</span>} kapwing={<span className="text-muted text-sm">Paid</span>} />
                <ComparisonRow feature="Self-hostable" klippo={checkIcon} opusclip={<span className="text-muted text-sm">No</span>} kapwing={<span className="text-muted text-sm">No</span>} />
                <ComparisonRow feature="AI YouTube Thumbnail Generator" klippo={checkIcon} opusclip={<span className="text-muted text-sm">No</span>} kapwing={<span className="text-muted text-sm">Paid</span>} />
                <ComparisonRow feature="AI Title & Description Generator" klippo={checkIcon} opusclip={<span className="text-muted text-sm">Limited</span>} kapwing={<span className="text-muted text-sm">Paid</span>} />
                <ComparisonRow feature="AI UGC Video Generator" klippo={checkIcon} opusclip={<span className="text-muted text-sm">No</span>} kapwing={<span className="text-muted text-sm">No</span>} />
                <ComparisonRow feature="AI Actors with Lip-Sync" klippo={checkIcon} opusclip={<span className="text-muted text-sm">No</span>} kapwing={<span className="text-muted text-sm">No</span>} />
                <ComparisonRow feature="Usage Limits" klippo={<span className="text-ok text-sm">Unlimited</span>} opusclip={<span className="text-muted text-sm">Per plan</span>} kapwing={<span className="text-muted text-sm">Per plan</span>} />
              </tbody>
            </table>
          </div>
        </div>
      ...
      <section className="py-20 px-6 border-t border-rule">
        <div className="max-w-5xl mx-auto">
          <SectionHeader eyebrow="10 · Use Cases" title="Who Uses Klippo?">
      ...
      <section id="faq" className="py-20 px-6 border-t border-rule">
        <div className="max-w-3xl mx-auto">
          <SectionHeader eyebrow="11 · FAQ" title="Frequently Asked Questions">
            Everything you need to know about Klippo, from setup to features.
          </SectionHeader>
      ...
      <footer className="border-t border-rule py-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="border-t border-rule pt-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <img src="/brand/favicon.svg" alt="Klippo" className="w-6 h-6" />
              <span className="text-sm text-muted">Klippo — Clip Generator & AI UGC Video Creator</span>
            </div>
